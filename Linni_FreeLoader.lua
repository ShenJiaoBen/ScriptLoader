...
local GameIDs = {
    ...
    EatTheWorld = {16480898254, 17776699224}, -- 吃吃世界
...
local function setCreatorVariables(creatorName)
    if creatorName == "BladeBall" then
        LnScript = "霖溺-刀刃球"
            elseif creatorName == "boxingame" then
    LnScript = "霖溺-无标题拳击"
...
local function getGameScriptUrl(gameName)
    local urls = {
        ...
        gofish = "https://raw.githubusercontent.com/ShenJiaoBen/Partial-Server-Ribbon/refs/heads/main/GoToFishing.lua",
...
local function getCreatorScriptUrl(creatorName)
    local urls = {
        ...
        boxingame = "https://raw.githubusercontent.com/ShenJiaoBen/Partial-Server-Ribbon/refs/heads/main/boxingame.lua",
